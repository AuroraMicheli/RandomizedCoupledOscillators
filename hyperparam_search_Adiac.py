...
# =============================
# Adiac Hyperparameter Search — Phase 2
# =============================
# Phase 1 best config (from current defaults):
#   dt=0.097, gamma=3.077, epsilon=0.02, gamma_range=3.28,
#   epsilon_range=0.20, inp_scaling=9.87, rho=0.87,
...
NARROW_SPACE = {
    "dt":            (0.02,   0.3),     # log: best=0.097
    "gamma":         (1.0,    7.0),     # log: best=3.077
    "epsilon":       (0.005,  0.1),     # log: best=0.02
    "gamma_range":   (1.0,    5.0),     # linear: best=3.28
    "epsilon_range": (0.05,   0.8),     # linear: best=0.20
    "inp_scaling":   (3.0,    30.0),     # log: best=9.87
    "rho":           (0.6,    1.1),     # linear: best=0.87
...
READOUT_C_WEIGHTS = [0.05, 0.20, 0.40, 0.25, 0.10]

N_SAMPLES      = 150
EXPLOIT_FRAC   = 0.80
SEED           = 42
N_HID          = 800
RESULTS_DIR    = Path("hyperparam_search_Adiac_phase2")
SCRIPT_NAME    = "Adiac_spiking_ron.py"
RESULTS_SUBDIR = "results_adiac"
...
print(f"Adiac phase 2 search (readout=final): {N_SAMPLES} configs "
