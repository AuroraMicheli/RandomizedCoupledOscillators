...
from ucr_data_utils import get_FordB_data
...
def main():
    parser = argparse.ArgumentParser(description='Spiking RON on FordB Dataset')
    ...
    # Results
    parser.add_argument('--results_dir', type=str, default='results_fordB',
                       help="Directory to save results")
    
    args = parser.parse_args()

    print("=" * 70)
    print("SPIKING RON ON FORDB DATASET")
    print("=" * 70)
    print(args)
    print("=" * 70)
    ...
    print("\n=== Loading FordB Dataset ===")
    train_loader, valid_loader, test_loader = get_FordB_data(
        args.batch, bs_test, data_dir=args.data_dir, whole_train=True
    )
    print(f"✅ Loaded FordB dataset")
    ...
    results_filename = f"results_fordB_nhid{args.n_hid}_{conn_lif_str}_{conn_hrf_str}_trials{args.test_trials}_seed{args.seed}.json"
